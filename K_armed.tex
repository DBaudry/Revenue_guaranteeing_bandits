\section{Analysis of Fair-MAB in $K$-armed bandits}\label{app::K_armed}
...
%\hr{Remark: in the Greedy case you have:
%\begin{align*}
%V_1 &= \lambda_k \bE\left[\sum_{t=1}^T \left(\frac{\wt \mu_{k,t}-\mu_k}{\wt \mu_{k,t}}\right) \ind(\cG_t)\right] \\
%&\leq \lambda_k \bE\left[\sum_{t=1}^T \left(1 - \frac{\mu_k}{\wh \mu_{k,t}}\right)\right] \\
%&\leq \lambda_k \sum_{t=1}^T \left(1 - \frac{\mu_k}{\bE \left[\wh \mu_{k,t} \right]}\right) = 0
%\end{align*}
%}
